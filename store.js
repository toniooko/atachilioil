...
const STALE_KEYS = ['ata_site_v1', 'ata_site_v2', 'ata_site_v3', 'ata_site_v4', 'ata_site_v5', 'ata_site_v6', 'ata_site_v7', 'ata_country_v1'];
...
function loadCountry() {
  ...
  try {
    ...
    if (v) {
      try {
        saved = JSON.parse(v)?.code || null;
      } catch (e) {}
    }
    return saved || window.__ATA_DEFAULTS && window.__ATA_DEFAULTS.defaultCountryCode || null;
  } catch (e) {}
  return null;
}
